...
class StageRepository extends ServiceEntityRepository
    ...
    public function __construct( ManagerRegistry $registry )
 {
    ...
    */
    ...
    public function findAllVisibleQuery( RechercheStage $search, string $orderBy = NULL, $validee = true )
 {
        ...
        if ( $validee ) {
            $query = $query->andWhere( 's.validee = 1' );
        } else {
            $query = $query->andWhere( 's.validee = 0' );
        }

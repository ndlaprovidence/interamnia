 ...
 */
final class Version20200123134310 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE tbl_compterendu (id INT AUTO_INCREMENT NOT NULL, entreprise_id INT NOT NULL, eleve_id INT NOT NULL, prof_id INT NOT NULL, date_debut VARCHAR(255) NOT NULL, date_fin VARCHAR(255) NOT NULL, theme VARCHAR(255) NOT NULL, commentaire VARCHAR(255) DEFAULT NULL, INDEX IDX_A8031AA6A4AEAFEA (entreprise_id), INDEX IDX_A8031AA6A6CC7B2 (eleve_id), INDEX IDX_A8031AA6ABC1F7FE (prof_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB');
